...
// --- Icons ---
import { BoldIcon } from "@/components/tiptap Startkit/tiptap-icons/bold-icon"
import { Code2Icon } from "@/components/tiptap Startkit/tiptap-icons/code2-icon"
import { ItalicIcon } from "@/components/tiptap Startkit/tiptap-icons/italic-icon"
import { StrikeIcon } from "@/components/tiptap Startkit/tiptap-icons/strike-icon"
import { SubscriptIcon } from "@/components/tiptap Startkit/tiptap-icons/subscript-icon"
import { SuperscriptIcon } from "@/components/tiptap Startkit/tiptap-icons/superscript-icon"
import { UnderlineIcon } from "@/components/tiptap Startkit/tiptap-icons/underline-icon"
